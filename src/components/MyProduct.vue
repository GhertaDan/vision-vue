<template>
  <div class="glasses__card card">
    <div class="card__img">
      <img src="../assets/img/sunglasses/sun1_1.png" alt="" />
    </div>
    ...
    <div class="card__button">
      <div class="card__favorite">
        <picture>
          <source srcset="img/icons/favorite.webp" type="image/webp" />
          <img src="img/icons/favorite.png" alt="favorite" class="card__icon"
        /></picture>
      </div>
      <div class="card__add">
        <svg
