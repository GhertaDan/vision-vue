        ...
        <div class="profile">
          <div class="profile__container">
            <div class="profile__info">
              ...
              <div class="profile__info-descr">
                <h3 class="profile__info-username">Ume Daki</h3>
                <div class="profile__info-date">
                  <label for="">Email</label>
                  <input type="text" value="vision_demo@gmail.com" disabled />
                </div>
                <div class="profile__info-date">
                  <label for="">Contact</label>
                  <input type="text" value="9843971688" disabled />
                </div>
                <div class="profile__info-date">
                ...
                <div class="profile__info-wrapper">
                  <button class="profile__btn btn-edit">Edit</button>
                  <button class="profile__btn btn-logout" id="btnLogout">
                    Log out
                  </button>
                </div>
              </div>
            ...
            <div class="profile__wrapper">
              <div class="profile__block">
                <div class="profile__title">Purchase history</div>
                <div class="profile__content">
                  <div class="profile__content-item item">
                    <div class="item__wrapper">
                      <div class="item__img">
                        <img src="img/sunglasses/sun1 1.png" alt="" />
                      </div>
                      <div class="item__box">
                        <div class="item__name">Premium Square Sunglasses</div>
                        <div class="item__price">$32.95</div>
                        <div class="item__date">14th February 2022</div>
                      </div>
                    </div>
                  </div>
                  <div class="profile__content-item item">
              ...
              <div class="profile__block">
                <div class="profile__title">wishlist</div>
                <div class="profile__content wish">
                  <div class="wish__wrapper">
                    <div class="wish__img">
                      <img src="img/sunglasses/sun1 1.png" alt="" />
                    </div>
                    <div class="wish__box">
                      <div class="wish__name">Premium Sunglasses</div>
                      <div class="wish__price">$32.95</div>
                    </div>
                    <div class="wish__cart">
                      <svg
                        width="31"
                        height="27"
                        viewBox="0 0 31 27"
